    ...
    <div>
      ...
      {equipment && (
        <div style={{ marginTop: "1rem" }}>
          ...
          <p>
            <strong>Készlet:</strong> {equipment.stock}
          </p>
          <p>
            <strong>Ár:</strong> {equipment.price} Ft
          </p>
          <p>
            <strong>Helyszín:</strong> {equipment.location?.name}
          </p>

          <p>
            <strong>Kollégium:</strong> {equipment.dormitory?.name}
          </p>
        </div>
      )}
    </div>
